...
const th: ThemesCopy = {
  "metaTitle": "ธีม — Muqun",
  "metaDescription": "ธีมจากชุมชน Muqun พร้อมตัวอย่างจากไฟล์ธีมจริง ทั้งโหมดสว่างและมืดบนมือถือและแท็บเล็ต",
  "eyebrow": "Muqun · ธีม",
  "heading": "ธีม",
  "lead": "ดูธีมจากชุมชนที่แสดงผลจากไฟล์ .muqun-theme จริง ทั้งโหมดสว่างและมืดบนมือถือและแท็บเล็ต พร้อมสีเทอร์มินัลและภาพประกอบ ดาวน์โหลดแล้วนำเข้าในแอปได้เลย",
  "repoCta": "ดูคลังธีม",
  "loading": "กำลังโหลดรายการธีม…",
  "empty": "ยังไม่มีธีมที่เผยแพร่ ธีมแรกอาจเป็นของคุณ",
  "failed": "ไม่สามารถโหลดรายการธีมได้ในขณะนี้",
  "retry": "ลองอีกครั้ง",
  "count": "{count} ธีม",
  "search": "ค้นหาธีม",
  "noMatch": "ไม่พบธีมที่ตรงกับ “{query}”",
  "card": {
    "preview": "ดูตัวอย่าง",
    "loadPreview": "โหลดตัวอย่าง ({size})",
    "loadingPreview": "กำลังอ่านแพ็กเกจ…",
    "previewFailed": "ไม่สามารถอ่านแพ็กเกจนี้ได้",
    "download": "ดาวน์โหลด"
  },
  "detail": {
    "back": "ธีมทั้งหมด",
    "download": "ดาวน์โหลด .muqun-theme",
    "copyLink": "คัดลอกลิงก์",
    "copied": "คัดลอกแล้ว",
    "source": "ซอร์สโค้ด",
    "install": "ดาวน์โหลดไฟล์แล้วเปิดด้วย Muqun หรือนำเข้าที่ การตั้งค่า → ธีม",
    "authorPreview": "ภาพตัวอย่างจากผู้สร้าง",
    "version": "เวอร์ชัน",
    "author": "ผู้สร้าง",
    "license": "สัญญาอนุญาต",
    "minApp": "เวอร์ชัน Muqun ขั้นต่ำ",
    "size": "ขนาด",
    "assets": "รูปภาพ",
    "light": "สว่าง",
    "dark": "มืด",
    ...
    "terminal": "เทอร์มินัล",
    "ansi": "สี ANSI",
    "decorations": "ตำแหน่งตกแต่ง",
    "icons": "ไอคอน",
    "noArtwork": "โหมดนี้ไม่มีภาพประกอบ",
    "surfaceOpacity": "ความทึบของพื้นผิว",
    "terminalOpacity": "ความทึบของเทอร์มินัล"
  },
  "screens": {
  ...
  "preview": {
    "metaTitle": "ตัวอย่างธีม — Muqun",
    "heading": "ตัวอย่างธีม",
    "lead": "ดูธีมจากที่อยู่ใดก็ได้ในรูปแบบเดียวกับคลังธีม กำหนด source เป็นโฟลเดอร์ที่มี theme.json และ assets/ หรือเป็นไฟล์ .muqun-theme บนเซิร์ฟเวอร์ที่อนุญาตการอ่านข้ามต้นทาง",
    "source": "แหล่งที่มา",
    "noSource": "ยังไม่ได้ระบุแหล่งที่มา เพิ่ม ?source=https://… ในที่อยู่",
    "loading": "กำลังโหลดธีม…",
    "failed": "ไม่สามารถโหลดธีมจากแหล่งนี้ได้",
    "refresh": "โหลดใหม่เมื่อแหล่งข้อมูลเปลี่ยน",
    "updated": "อัปเดตแล้ว"
  },
  "local": {
    "heading": "ดูตัวอย่างธีมของคุณ",
    "lead": "ลากไฟล์ .muqun-theme มาที่นี่เพื่อดูตัวอย่างแบบเดียวกับคลังธีม ไฟล์จะไม่ถูกส่งออกจากเบราว์เซอร์",
    "pick": "เลือกไฟล์",
    "drop": "หรือลากมาวางที่นี่",
    "reading": "กำลังอ่านไฟล์…",
    "failed": "เว็บไซต์นี้ไม่สามารถอ่านไฟล์นี้เป็นธีมได้",
    "clear": "ล้าง",
    "url": "กำลังแก้ไขธีมหรือเก็บธีมไว้บนเซิร์ฟเวอร์? หน้าตัวอย่างโหลดจาก URL และรีเฟรชตามการเปลี่ยนแปลงได้",
    "urlCta": "ดูตัวอย่างจาก URL"
  },
  "making": {
    "heading": "สร้างธีมของคุณ",
    "body": "ธีมเป็นไฟล์ ZIP ขนาดเล็ก ประกอบด้วย JSON กำหนดสีและโฟลเดอร์ assets เก็บภาพ เครื่องมือช่วยสร้างโครง ตรวจความต่างของสี และแพ็กธีม ส่งผลงานผ่าน Pull Request ได้",
    "repo": "ร่วมแบ่งปันธีม",
    "cli": "เครื่องมือสร้างธีม",
    "steps": [
      {
        "title": "สร้างโครงธีม",
        "body": "คำสั่งเดียวสร้างธีมที่ติดตั้งได้พร้อมภาพตัวอย่าง หรือจะติดตั้ง skill แล้วบอกผู้ช่วย AI ว่าอยากได้หน้าตาแบบไหนก็ได้"
      },
      {
        "title": "ตรวจสอบ",
        "body": "validate ใช้การตรวจสอบเดียวกับแอป ส่วน contrast ตรวจความต่างของสีเมื่อมีความโปร่งใส ทั้งสองคำสั่งใช้กับโฟลเดอร์ได้โดยไม่ต้องแพ็ก"
      },
      {
        "title": "ส่งผลงาน",
        "body": "เปิด Pull Request โดยส่งเฉพาะโฟลเดอร์ src/<id> ระบบ CI จะแพ็กธีมให้ และธีมจะปรากฏที่นี่ภายในไม่กี่นาทีหลังรวมโค้ด"
      }
    ]
  }
};
