...
function revealBands() {
  // The asynchronous catalogue and the support guide own their specialized reveals.
  // Band-level transforms would otherwise conflict with their dedicated timelines.
  if (document.querySelector('.mq-themes-gallery') || document.querySelector('.mq-guide-hero')) return;
